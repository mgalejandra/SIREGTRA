...
$mail->FromName = "Beneficiarios Registrados de Citas";
$mail->Subject ="Registro de Beneficiarios de citas al ".$today;
...
$mail->WordWrap = 50;
		   ...
		   $cuerpo = '<html><head>
            ...
            <table border="1">
			 <tr>
			  <td ALIGN="center" bgcolor="8C0000" width="1300" colspan="18"><font color="#FFFFFF"> LISTA DE BENEFICIARIOS REGISTRADOS DE CITAS EL DIA '.$today.'</font></td>
			</tr>
			<tr>
		...
		$sql="
			  ...
			  where
			  propietarios.status='A'  and 	propietarios.tipo=b.codtipben and fecha ='".$fecha."' and fecha_reg<fecha
...
$mail->Body =$cuerpo;
$mail->AltBody = "Listado de beneficiarios registrados de citas en el Sistema SIRECOV al ".$fecha;
