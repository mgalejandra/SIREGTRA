...
$listarReclamos = $objReclamo->listarReclamos($fec,$codpro,-1,$id_reclamo,$sercarveh,$fec2,$nombre,$sexo,$descripcion,$codmar,$codmodveh,$codserveh,$banco,$respuesta);
...
$tipoR = $objReclamo->listarTipoR($listarReclamos[$i+7]);
