...
$listVehiculos=$objVehiculo->listarVehiculos($sercarveh,$codmar,$modveh,$serveh,'I',$lote,$factura,$taller,$tt);
...
$pdf->SetXY(10,35);
$pdf->Cell(250,5,'LISTADO DE VEHICULOS IMPORTADOS',0,0,'C',0);
