...
$detalle1 = utf8_decode("		Tengo el agrado de dirigirme a usted, en la oportunidad de expresarle un cordial saludo Bolivariano y Revolucionario," .
		                " la presente es con el fin de informarle que se realiza la entrega de ".montoLetras($cant).' '."(".$cant.") expedientes," .
		                " pertenecientes al Operativo del Plan Socialista de Vehículo para iniciar el proceso de aprobación de dichos créditos, como se detalla en la relación anexa. ");
...
$pdf->setY(243);
$pdf->SetFont('Arial','B',10);
$pdf->MultiCell($XC,$YC,utf8_decode('WILSON DAVID HERRERA BERMUDEZ'),0,'C');
$pdf->ln(5);
...
$pdf->SetX($pdf->GetX()+5);
$pdf->SetFont('Arial','',8);
$cabecera = array('N#','Rif','Nombre','Apellido','Telefono 1','Telefono 2');

$anchos = array(5,20,57,57,23,20);
$alinea = array('C','C','L','L','R','R');
$pdf->cabecera($cabecera,$anchos);
...
$fechahoy = $aa.$mm.$dd;
$pdf->Output("$fechahoy Memo Expediente",'I');
?>