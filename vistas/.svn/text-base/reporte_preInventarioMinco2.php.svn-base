  ...
  <legend>Listado de Veh&iacute;culos Entregados y En Campo</legend>
    ...
    <tr><td colspan="23" align="right">
             ...
             <tr>
			  ...
			  <td class="cabecera">Asignados que no aprobaron PDI</td>
			  <td class="cabecera">Asignados que aprobaron PDI</td>
...
?>
              <tr class="<?php echo $color ?>">
               ...
               <?php if ($listVehAsigPreInv[$i+1]=="GRAND TIGER 4X4") { ?><td align="center"><? echo $imprimoT44e.'entregados'; ?></td><?php } ?>
        ...
        <?php }  ?>
              ...
              // $preproformas= $listVehAsigPreInvInicial[0];
			     ...
			     echo $asignados.'asig1';
			   //echo $asignados.'aqui';

			   $totalAs+=$asignados;
               ?></td>
                   <? //$listVehNoPDI1=$objVehiculo->listVehNoPDI('',$listVehAsigPreInv1[$i+1],'','','','',-1);
                  $listVehNoPDI2=$objVehiculo->listVehNoPDI('',$listVehAsigPreInv[$i],'',14,'','AS',-1);
               ...
               <?php if ($listVehAsigPreInv[$i+1]=="GRAND TIGER 4X4") { ?><td align="center"><? echo $imprimoT44.'aqui3'; ?></td><?php } ?>
               <?php }
        		//$sumoB = $sumoA + $cuenta;
        ?>
               ...
               <?php if ($listVehAsigPreInv[$i+1]=="GRAND TIGER 4X4") { ?><td align="center"><? echo $imprimoT442.'aqui2'; ?></td><?php } ?>
               <?php } ?>
                       		<?php if (($listVehAsigPreInv[$i+1]=="X1") or ($listVehAsigPreInv[$i+1]=="TIGGO") or ($listVehAsigPreInv[$i+1]=="QQ3")  or ($listVehAsigPreInv[$i+1]=="GRAND TIGER 4X2")  or ($listVehAsigPreInv[$i+1]=="GRAND TIGER 4X4")) { ?>
		       <?php if ($listVehAsigPreInv[$i+1]=="QQ3") { ?><td align="center"><? echo $asignados-$imprimoQ2; ?></td><?php } ?>
               <?php if ($listVehAsigPreInv[$i+1]=="X1") { ?><td align="center"><? echo $asignados-$imprimoX2; ?></td> <?php } ?>
               <?php if ($listVehAsigPreInv[$i+1]=="TIGGO") { ?><td align="center"><? echo $asignados-$imprimoTIG2; ?></td><?php } ?>
               <?php if ($listVehAsigPreInv[$i+1]=="GRAND TIGER 4X2") { ?><td align="center"><? echo $asignados-$imprimoTG42; ?></td><?php } ?>
               <?php if ($listVehAsigPreInv[$i+1]=="GRAND TIGER 4X4") { ?><td align="center"><? echo $asignados-$imprimoT442.'aqui2'; ?></td><?php } ?>
               <?php } ?>
               <td align="center"><?php echo $listVehAsigPreInv[$i+3].'inv';   $totalInv+=$listVehAsigPreInv[$i+3]; ?></td>
...
?>
        ...
        ?>
                   <? //$listVehNoPDI1=$objVehiculo->listVehNoPDI('',$listVehAsigPreInv1[$i+1],'','','','',-1);
                  $listVehNoPDI2=$objVehiculo->listVehNoPDI('',$listVehAsigPreInv[$i],'',16,'','AS',-1);
                  $cuenta2 = count($listVehNoPDI2)/13;
				  $totalCuenta2+=$cuenta2;
