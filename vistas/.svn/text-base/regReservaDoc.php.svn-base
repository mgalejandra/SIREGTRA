...
validaAcceso($permitidos,$dir);
      ...
      if ($indReg==22)
      {
    	 ...
    	 $datos[2] = $fechaR;
 		  ...
 		  $actualizaR = $objFactura->actualizaReserva($datos,$codproc,$serial);

 		if ($actualizaR)
 		{
 		 	echo '<SCRIPT>alert("Documento de Reserva de Dominio registrado");</SCRIPT>';
...
<fieldset >
  <legend>&nbsp;Cargar Documento Reserva de Dominio
	<TABLE  width="550">
	<tr>
		    ...
		    <tr>
			<td class="cabecera">Doc. Reserva:</td>
