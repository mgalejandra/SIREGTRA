...
require('../modelos/usuarios.php');
	...
	$dir='http://'.$host.$uri;
    $permitidos = array(1,2,3,4,5,6,7,8,13,15,17,18,23);
...
$contRemision = $objCertificado->contarMemo($id_memo,$desde,$hasta,$certificado,$banco,$rif,$usuario);
...
$listarRemision=$objCertificado->listarMemo1($id_memo,$desde,$hasta,$certificado,$banco,$rif,$offset,$usuario);
...
function exel(URL) {
	  ...
	  id = day.getTime();
	  eval("page" + id +
	  	   " = window.open('reportes/xlsListarCertificado.php?id=<?php echo $listarRemision[$i+0]?>&id='+URL,'','toolbar=0,scrollbars=1,location=0,statusbar=1,menubar=0,resizable=0,width=1100,height=900');");
}
               ...
               <td align="center"><?= $listarRemision[$i+6]?></td>
		        ...
		        <td>
	               <div align="center">
                      ...
                      <a class="vinculo" href="" target="_blank" onClick="popup('reportes/xlsListarCertificado.php?id=<?php echo $listarRemision[$i]?>');return false;">
