 ...
 <form action="" method="post" name="form1" >
  ...
  <tr >
    ...
    <td><table  width="44%" height="197" align="center" background="imagenes/fon.jpg">
      <tr class="menu01" >
        <td height="21" colspan="2"><div align="center" class="headline"><font ><strong> Estado </strong></font></div></td>
      </tr>
      <tr class="menu01" >
      ...
      <tr >
        ...
        <td width="54%"><font color="#FFFFFF">
          <input name="cod" type="text" id="cod" maxlength="3"  onblur="javascript:this.value=this.value.toUpperCase()" />
        </font></td>
      </tr>
      <tr >
        <td class="TitNot"><div align="right"><strong>Descripci&oacute;n:</strong></div></td>
        <td><font color="#FFFFFF">
          <input name="nomb" type="text" id="nomb" maxlength="30" onblur="javascript:this.value=this.value.toUpperCase()" />
        </font></td>
      </tr>
      ...
      <tr >
        <td height="26" colspan="2"><div align="center">
          <input type="button" name="buscar" value="Buscar" onclick="buscarDatosEstado('con_cat_estado.php?opc=1'); return false" />
      ...
      <tr >
        <td height="26" colspan="2"><div id="resultado">
            <?php  include('con_cat_estado.php');?>
        </div></td>
      </tr>
    </table></td>
    <td>&nbsp;</td>
