...
require('../modelos/entrega.php');
  ...
  $idpreinv=$_POST['preinv'];
  $pgActual = $_POST['pagina'];
  $indBusq=$_POST['indBusq'];
  $conciliar= $_POST['conciliar'];
...
if ($indBusq == 3 ){
		$actualizar = $objInventario->conciliarInventario($conciliar,$idpreinv);
	if ($actualizar){
      	echo '<SCRIPT>';
	    echo 'alert("Inventario Conciliado Correctamente");';
	      //$listarArticulo = $objInventario->buscarDisponibles($idDis,$_SESSION['distOrg']);
	 	echo '</SCRIPT>';
	 	echo "<SCRIPT>window.location.href='reporte_preinv_concil.php';</SCRIPT>";
	 }/*else{
		echo '<SCRIPT>alert("Error al Conciliar Inventario");</SCRIPT>';
	}*/
...
<html>
  ...
  function enviar2(campo){
	window.document.inventario.indBusq.value = campo;
	var conf = confirm ('Esta Seguro que Desea Conciliar el inventario');
	        if(conf){
	        	window.document.inventario.submit();
	  	    }
  }
    ...
    <tr><td colspan="23" align="right">
             ...
             <tr>
			  ...
			  <td class="cabecera">Inventario</td>
			  	  <td class="cabecera">Real</td>
			  <td class="cabecera">En Campo</td>
			   <td class="cabecera">Conciliar</td>
             </tr>
<?php
      if($numlotveh)
      {
...
<?php if ($listVehAsigPreInvL[$i+1]=="QQ3") { ?><td align="center"><? $cant=($listVehAsigPreInvL[$i+2]-$imprimoQeL-$asignadosL-$imprimoQL); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInvL[$i+1]=="X1") { ?><td align="center"><? $cant=($listVehAsigPreInvL[$i+2]-$imprimoXeL-$asignadosL-$imprimoXL); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInvL[$i+1]=="TIGGO") { ?><td align="center"><? $cant=($listVehAsigPreInvL[$i+2]-$imprimoTIGeL-$asignadosL-$imprimoTIGL); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInvL[$i+1]=="GRAND TIGER 4X2") { ?><td align="center"><? $cant=($listVehAsigPreInvL[$i+2]-$imprimoTG4L-$asignadosL-$imprimoTG4eL); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInvL[$i+1]=="GRAND TIGER 4X4") { ?><td align="center"><? $cant=($listVehAsigPreInvL[$i+2]-$imprimoT44L-$asignadosL-$imprimoT44eL); echo $cant ?></td><?php } ?>
               <td align="center"><?php echo $campoL; ?></td>
                 <td> <input name="conciliar[]" type="text" id="conciliar[]" value="<?$conciliar?>" size="3" maxlength="3"/> </td>
                 <td> <input name="preinv[]" type="hidden" id="preinv[]" value="<? echo $listVehAsigPreInvL[$i+8]?>" size="3" maxlength="3"/> </td>
              </tr>
<?php     }
        }
?>
...
<?php if ($listVehAsigPreInv[$i+1]=="QQ3") { ?><td align="center"><? $cant=($listVehAsigPreInv[$i+2]-$imprimoQe-$asignados-$imprimoQ); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInv[$i+1]=="X1") { ?><td align="center"><? $cant=($listVehAsigPreInv[$i+2]-$imprimoXe-$asignados-$imprimoX); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInv[$i+1]=="TIGGO") { ?><td align="center"><? $cant=($listVehAsigPreInv[$i+2]-$imprimoTIGe-$asignados-$imprimoTIG); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInv[$i+1]=="GRAND TIGER 4X2") { ?><td align="center"><? $cant=($listVehAsigPreInv[$i+2]-$imprimoTG4-$asignados-$imprimoTG4e); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInv[$i+1]=="GRAND TIGER 4X4") { ?><td align="center"><? $cant=($listVehAsigPreInv[$i+2]-$imprimoT44-$asignados-$imprimoT44e); echo $cant ?></td><?php } ?>
               <td align="center"><?php echo $campo; //$campo = $existencia - $sumoC; ?></td>
              <td> <input name="conciliar[]" type="text" id="conciliar[]" value="<?$conciliar?>" size="3" maxlength="3"/> </td>
             <td> <input name="preinv[]" type="hidden" id="preinv[]" value="<? echo $listVehAsigPreInv[$i+8]?>" size="3" maxlength="3"/> </td>
              </tr>
<?php     }
        }
?>
...
<?php if ($listVehAsigPreInv1[$i+1]=="QQ3") { ?><td align="center"><? $cant=($listVehAsigPreInv1[$i+2]-$imprimoQe1-$asignados1-$imprimoQ1); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInv1[$i+1]=="X1") { ?><td align="center"><? $cant=($listVehAsigPreInv1[$i+2]-$imprimoXe1-$asignados1-$imprimoX1); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInv1[$i+1]=="TIGGO") { ?><td align="center"><? $cant=($listVehAsigPreInv1[$i+2]-$imprimoTIGe1-$asignados1-$imprimoTIG1); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInv1[$i+1]=="GRAND TIGER 4X2") { ?><td align="center"><? $cant=($listVehAsigPreInv1[$i+2]-$imprimoTG41-$asignados1-$imprimoTG4e1); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInv1[$i+1]=="GRAND TIGER 4X4") { ?><td align="center"><? $cant=($listVehAsigPreInv1[$i+2]-$imprimoT441-$asignados1-$imprimoT44e1); echo $cant ?></td><?php } ?>
               <td align="center"><?php echo $campo1; ?></td>
                   <td> <input name="conciliar[]" type="text" id="conciliar[]"  value="<?$conciliar?>" size="3" maxlength="3"/> </td>
               <td> <input name="preinv[]" type="hidden" id="preinv[]" value="<? echo $listVehAsigPreInv1[$i+8]?>" size="3" maxlength="3"/> </td>
              </tr>
<?php     }
        }
?>
...
<?php if ($listVehAsigPreInv2[$i+1]=="QQ3") { ?><td align="center"><? $cant=($listVehAsigPreInv2[$i+2]-$imprimoQe2-$asignados2-$imprimoQ2); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInv2[$i+1]=="X1") { ?><td align="center"><? $cant=($listVehAsigPreInv2[$i+2]-$imprimoXe2-$asignados2-$imprimoX2); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInv2[$i+1]=="TIGGO") { ?><td align="center"><? $cant=($listVehAsigPreInv2[$i+2]-$imprimoTIGe2-$asignados2-$imprimoTIG2); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInv2[$i+1]=="GRAND TIGER 4X2") { ?><td align="center"><? $cant=($listVehAsigPreInv2[$i+2]-$imprimoTG4e2-$asignados2-$imprimoTG42); echo $cant ?></td><?php } ?>
<?php if ($listVehAsigPreInv2[$i+1]=="GRAND TIGER 4X4") { ?><td align="center"><? $cant=($listVehAsigPreInv2[$i+2]-$imprimoT44e2-$asignados2-$imprimoT442); echo $cant ?></td><?php } ?>

               <td align="center"><?php echo $campo2; ?></td>

                <td> <input name="conciliar[]" type="text" id="conciliar[]"  value="<?$conciliar?>" size="3" maxlength="3"/> </td>
               <td> <input name="preinv[]" type="hidden" id="preinv[]" value="<? echo $listVehAsigPreInv2[$i+8]?>" size="3" maxlength="3"/> </td>
              </tr>
<?php     }
        }
?>
...
<TABLE class="completo">
 <tr>
       <td colspan="8" align="center">
       	<input name="Botn" type="button" onclick="enviar2(3)"  value="Conciliar Inv">
       </td>
       </tr>
       </table>
</fieldset>
