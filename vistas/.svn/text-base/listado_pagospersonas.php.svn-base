...
require('../modelos/reportes.php');
	...
	$dir='http://'.$host.$uri;
    $permitidos = array(1,2,3,4,5,6,7,15,18,22,23,25);
...
$contFactura=$objReporte->listaPagospersonas(-1,$banco,$codpro,$nombre,$fecP,$fec2P);
...
$listarFactura=$objReporte->listaPagospersonas($offset,$banco,$codpro,$nombre,$fecP,$fec2P);
...
function exel(URL) {
	  ...
	  id = day.getTime();
	  eval("page" + id +
	  	   " = window.open('reportes/xlsListarPagospersonas.php?banco=<?php echo $banco;?>&codpro=<?php echo $codpro;?>&nombre=<?php echo $nombre;?>&fecP=<?php echo $fecP;?>&fec2P=<?php echo $fec2P;?>&id='+URL,'','toolbar=0,scrollbars=1,location=0,statusbar=1,menubar=0,resizable=0,width=1100,height=900');");
}
     ...
     <table  align="center" >
           ...
           <td  class="dato" colspan="3">
			 <SELECT id="banco" name="banco">
				    <option value="<?php if ($banco) echo $banco?>"><?php if ($banco) echo $listarFactura[5];?></option>
 ...
 <fieldset class="form">
  <legend>Listado de Factura &nbsp; <?php if ($tipo=='E') echo 'Anulados'; ?> &nbsp; <?php echo 'Total: '.$contArt?></legend>
    <table width="90%" align="center" class="detalles">
        ...
        ?>
             <TR>
             <td class="cabecera"  width="1%" colspan=6>
