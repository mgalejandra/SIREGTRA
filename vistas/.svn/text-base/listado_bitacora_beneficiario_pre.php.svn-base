...
$cantReg=$objBitacora->listarAuditoriaBeneficiarioPre($codpro,$movimiento,$usuario,$fecE,$fecE2,-1);
...
$listarBitacora=$objBitacora->listarAuditoriaBeneficiarioPre($codpro,$movimiento,$usuario,$fecE,$fecE2,$offset);
...
function exel(URL) {
	  ...
	  id = day.getTime();
	  eval("page" + id +
	  	   " = window.open('reportes/xlsListadoBitacBenef.php?usuario=<? echo $usuario;?>&codpro=<? echo $codpro; ?>&fecE=<? echo$fecE;?>&fecE2=<? echo$fecE2;?>&movimiento=<? echo$movimiento;?>
  ...
  <legend>Criterios de B&uacute;squeda
     ...
     <table  align="center" >
          <tr>
           ...
           <td>
              <input name="movimiento" type="text" id="movimiento" value="<?php echo $movimiento?>" size="20" width="60" maxlength="120"  onblur="javascript:this.value=this.value.toUpperCase()"/>
           </td>
          <tr> <td  class="categoria">&nbsp;Usuario:</td>
           <td>
...
<?php
       ...
       ?>
              ...
              <tr class="<?php echo $color ?>">
               ...
               <td><?php echo $listarBitacora[$i+1];?></td>
               <td><?php echo $listarBitacora[$i+5];?></td>
               <td><?php echo $listarBitacora[$i+2];?></td>
               <td><?php echo $listarBitacora[$i+3]." ".$listarBitacora[$i+4];?></td>
              </tr>
<?php     }
        }
?>
