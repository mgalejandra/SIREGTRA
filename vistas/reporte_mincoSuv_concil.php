...
require('../modelos/inventario.php');
	...
	if ($indBusq == 3 ){
	    ...
	    if ($actualizar){
      	//echo '<SCRIPT>';
      	 //echo	"<SCRIPT>window.document.inventario.submit();</SCRIPT>";
      	echo '<SCRIPT>alert("Inventario Conciliado Correctamente");</SCRIPT>';
      	$reporteMincoSuvinca=$objVehiculo->reporteMincoSuvinca($numlotveh);
     //  echo	"<SCRIPT>window.document.inventario.submit();</SCRIPT>";
      		//echo "<SCRIPT>window.location.href='reporte_mincoSuv_concil.php';</SCRIPT>";
...
?>
              ...
              <td align="center"><?php echo $inventario;?> </td>
               <td> <input name="conciliar[]" type="text" id="conciliar[]" value="<?$conciliar?>" size="3" maxlength="3"/> </td>
                <input name="preinv[]" type="hidden" id="preinv[]" value="<? echo $reporteMincoSuvinca[$i+12]?>" size="3" maxlength="3"/>
