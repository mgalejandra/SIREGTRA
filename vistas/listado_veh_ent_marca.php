...
$listado=$objVehM->reporteEntGral($acto,$modelo,$marca,$banco,$numlotveh);
...
<!--  Contenido Principal         -->
 ...
 <fieldset class="form">
  <legend>Lista de Veh&iacute;culos Entregados por Marca</legend>
    <table id="tabla2" name="tabla2" width="70%" align="center" class="detalles">
     <tr><td colspan="8" align="right"><a class="vinculo" target="_blank" onClick="abrir('reportes/pdfVehEntMarca.php?act=<? echo $acto ?>&mar=<? echo $marca ?>&mod=<? echo $modelo ?>&ban=<? echo $banco ?>&lote=<? echo $numlotveh ?>');" />
  <IMG title="PDF" src="botones/pdf.png" height="15" ></a></td></tr>
             ...
             <?
                 ...
                 if ($nroCampos==9) $titulo = $titulo." - Lote: ".$numlotveh;
...
<?php
		...
		for($i=0;$i<count($listado);$i+=$nroCampos){
			...
			// echo "<br>I: ".$i." - Dividendo: ".$listado[$i+6]." - Divisor: ".$listado[$i+2]." - Tasa: ".$tasa;;
?>
