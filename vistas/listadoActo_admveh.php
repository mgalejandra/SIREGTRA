...
require('../modelos/inventario.php');
	...
	$dir='http://'.$host.$uri;
    $permitidos = array(1,2,3,4,5,6,7,9,10,13,18,22);
...
?>
              ...
              <tr class="<?php echo $color ?>">
               ...
               <td><?php echo $listarFactura[$i+23];?></td>
