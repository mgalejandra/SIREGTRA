...
$contArt = $objUsuario->contarUsuario($usuario,$cedula,$tipo,$_SESSION['nivelUsu'],$nombre,$estatus,$usuario2,$_SESSION['idBanco']);
...
$resUsuario = $objUsuario->buscarUsuario($usuario,$cedula,$tipo,$_SESSION['nivelUsu'],$offset,$nombre,$estatus,$usuario2,$_SESSION['idBanco']);
...
if ($limp){
	...
	$cedula=null;
	$tipo=null;
	echo "<SCRIPT>window.location.href='listado_usuariosBanco.php';</SCRIPT>";
}
     ...
     <table  align="center" >
      ...
      <tr>
	    ...
	    <TD class="dato">
		       <select name="tipo" >
		       <option value=""></option>
			         <?php   $tipoUsuario = $objUsuario->retTipo('4');
...
<?php for($i=0;$i<count($resUsuario);$i+=$nroCampos){
 ...
 <TR class="<?php echo $color ?>">
   <TD><A class="vinculo" href="mod_usuario_ban.php?id=<?php echo ($resUsuario[$i])?>"><?php echo $resUsuario[$i]?></A></TD>
