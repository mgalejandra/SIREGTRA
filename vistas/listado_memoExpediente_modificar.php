...
require('../modelos/pago.php');
	...
	$dir='http://'.$host.$uri;
    $permitidos = array(1,2,3,4,5,6,7,8,13,15);
...
$contRemision = $objBeneficiario->contarMemo($id_memo,$desde,$hasta,$rif,$banco);
...
$listarRemision=$objBeneficiario->listarMemo1($id_memo,$desde,$hasta,$rif,$banco,$offset);
...
?>
              <tr id="dep<?=$i?>" class="datosimpar">
               <td align="center">
                <a class="vinculo" href="memoExpediente.php?id=<?php echo $listarRemision[$i+0]?>">
                   <?= $listarRemision[$i+0]; ?>
                </a>
                </td>
