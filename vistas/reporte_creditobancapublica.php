...
<html>
  ...
  function imprimir() {
	...
	id = day.getTime();
	eval("page" + id +
	     " = window.open('reportes/pdfCreditoBancaPublica.php','','toolbar=0,scrollbars=1,location=0,statusbar=1,menubar=0,resizable=0,width=1100,height=900');");
	}
 ...
 <?php
      	...
      	for($i=0;$i<count($diagnosticoCreditos);$i+=16){
        	 ...
        	 $indC = !$indC;
                        ...
                        $col4=$diagnosticoCreditos[$i+4]+($diagnosticoCreditos[$i+10]+$diagnosticoCreditos[$i+11])+
                             ($diagnosticoCreditos[$i+12]+$diagnosticoCreditos[$i+13]+$diagnosticoCreditos[$i+14]);
                        ...
                        $col5=$diagnosticoCreditos[$i+4]; $acum7+=$diagnosticoCreditos[$i+4];
...
?>
              <tr class="<?php echo $color ?>">
               ...
               <td align="center"><?php
                                        if($diagnosticoCreditos[$i]=='0003') { $indu=584+$diagnosticoCreditos[$i+2]; echo $indu; } //493
                                        if($diagnosticoCreditos[$i]=='0102') { $vzla=1497+$diagnosticoCreditos[$i+2]; echo $vzla; } //1831
                                     ...
                                     //   if($diagnosticoCreditos[$i]=='0149') { $puebl=172+$diagnosticoCreditos[$i+2]; echo $puebl; } //172
                                        if($diagnosticoCreditos[$i]=='0163') { $teso=2618+$diagnosticoCreditos[$i+2]; echo $teso; } //2574 //2783
                                        if($diagnosticoCreditos[$i]=='0175') { $bice=2534+$diagnosticoCreditos[$i+2]; echo $bice; } //2228
                                        if($diagnosticoCreditos[$i]=='0602') { $bandes=24+$diagnosticoCreditos[$i+2]; echo $bandes; }//24
 ...
 <td align="center"><?php
               ...
               <td align="center"><?php echo $col2.'neg';?> </td>
               <td align="center"><?php echo $col3.'rdto';?> </td>
               <td align="center"><?php echo $col4.'apro';?> </td>
               <td align="center"><?php echo $col5.'sin'; ?> </td>
               <td align="center"><?php echo $col6.'liq';?> </td>
               <td align="center"><?php echo $col7.'por';?> </td>
...
<legend>Resumen</legend>
    <table width="90%" align="center" class="detalles" border=0>
             ...
             <tr>
			  ...
			  <td width="5%"></td>
			  <td class="cabecera" width="15%">Diferencia</td>
			  <td align="center"><font color="red"><?php echo FormatoMonto($acum8-$acum9,0); ?></font></td>
			  <td align="center"><font color="red"><?php echo FormatoMonto(100-($acum9*100)/$acum8,2).'%'; ?></font></td>
