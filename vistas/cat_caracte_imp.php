...
$listCarac=$objCaract->listarCaracteristicasImp('',$codmar,$modveh,$serveh,$lote,$factura,$planilla);
?>
<!DOCTYPE HTML PUBLIC>
<html>
  <head>
  ...
  <legend>Criterios de B&uacute;squeda</legend>
     <table  align="center" >
        ...
        <td class="dato">
           ...
           <td  class="dato">
            <input name="factura" type="text" id="factura"  value="" />
          </td>
           <td  class="categoria">Planilla:</td>
           <td  class="dato">
           <input name="planilla" type="text" id="planilla"  value="" />
           </td>
          </tr>
          <tr>
