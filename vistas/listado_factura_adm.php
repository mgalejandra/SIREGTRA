...
$diat,$codmar,$codmodveh,$codserveh,$numlotveh,$numplaveh,$taller,$tt,$fecE,$fecE2,$tipoE,$tipoben,$fecfacori1,$fecfacori2,$numfacori,$preinv,$color,$acto,$ta,$todoacto,$tipoB,$riflab,$deslab);
...
$preinv,$color,'1','',$acto,$ta,'',$tipoB,$riflab,$deslab);
...
<?}?>
 ...
 <? if ($_SESSION['tipoUsuario']<>'18'){?>
              ...
              <?php } ?>
              <?php if ($_SESSION['tipoUsuario'] != 5 and $_SESSION['tipoUsuario'] != 6 and $_SESSION['tipoUsuario'] != 7 and $_SESSION['tipoUsuario']!= 11) { ?>
                 <td class="cabecera">R.F</td>
              <?php } ?>
                 <td class="cabecera"> I </td>
                 <?php if ($_SESSION['tipoUsuario'] != 5 and $_SESSION['tipoUsuario'] != 6 and $_SESSION['tipoUsuario'] != 7 and $_SESSION['tipoUsuario']!= 11) { ?>
                 <td class="cabecera">A</td>
              <?php } ?>
...
?>
			  ...
			  <? if ($listarFactura[$i+17]=='VEHICULO ENTREGADO'){ ?>
			  	  <td align="center" width="2%"><div title="Facturar nuevamente por error en nombre y era vehiculo entregado">
     ...
     <?php } ?>
	           <td><div align="center">
               <a class="vinculo" href="<?php if($listarFactura[$i+6]=='CREDITO' OR $listarFactura[$i+6]=='COMPLETO'){?>det_factura_admin<?php } if($listarFactura[$i+6]=='CONTADO'){?>det_factura_suvincaC<?php } ?>.php?idfactura=<?php echo $listarFactura[$i]?>&tip=<?php echo $tipo; ?>&preinv=<? echo $preinv1; ?>">
