...
$contRemision = $objBeneficiario->contarMemo($id_memo,$desde,$hasta,$rif,$banco,$usuario);
...
$listarRemision=$objBeneficiario->listarMemo1($id_memo,$desde,$hasta,$rif,$banco,$offset,$usuario);
