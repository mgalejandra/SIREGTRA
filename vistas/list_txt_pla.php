...
$contArt = $objenvios->ContarlistadoPlaTxt_hist($envio,$tipos,$sercarveh,$numpla,$nomcomp,$tipoEnvio,'');
...
//$listarcertificado=$objCertificado->listarCertificados('',$numcerveh,$sercarveh,$codpro,$nomcomp,$numfac1veh,$offset);
  $listarcertificado=$objenvios->listadoPlaTxt_hist($envio,$tipos,$sercarveh,$numpla,$nomcomp,$tipoEnvio,'',$offset);
?>
<!DOCTYPE HTML PUBLIC >
<html>
  <head>
...
<!--  Contenido Principal         -->
 ...
 <tr>
	     <td  class="categoria">N° Envio:</td>
          ...
          <td  class="categoria">N° Placa:</td>
            <td>
             <input name="numpla" type="text" id="numpla" value="" onblur="javascript:this.value=this.value.toUpperCase()" size="20" maxlength="10" />
          </td>
 ...
 <fieldset class="form">
  <legend>Histórico de Envíos de Placas</legend>
    <table width="100%" align="center" class="detalles">
             <tr>
              <td width="10%" class="cabecera">  N° Envio </td>
              <td width="20%"class="cabecera"> Placa </td>
              <td  width="20%" class="cabecera"> Nro Rafaga </td>

                <td width="30%" class="cabecera"> Serial </td>
              <td width="15%" class="cabecera"> Fecha Reg. </td>
             </tr>
<?php
        for($i=0;$i<count($listarcertificado);$i+=12){
...
?>
              ...
              <tr class="<?php echo $color ?>">
               ...
               <td align="center"><?php echo $listarcertificado[$i+11];?> </td>
               <td align="center"><?php echo $listarcertificado[$i+9];?> </td>
