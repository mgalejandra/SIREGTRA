...
<html>
  ...
  function imprimir() {
	...
	id = day.getTime();
	eval("page" + id +
	      " = window.open('reportes/pdf_reportemincoSuvinca2.php?numlotveh=<? echo $numlotveh; ?>','','toolbar=0,scrollbars=1,location=0,statusbar=1,menubar=0,resizable=0,width=1100,height=900');");
	}
...
<!--  Contenido Principal         -->
 ...
 <fieldset class="form">
  <legend>Listado de Veh&iacute;culos Chery Entregados y En Campo</legend>
