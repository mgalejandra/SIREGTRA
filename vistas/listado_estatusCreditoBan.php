...
$contCredito=$objBeneficiario->listarEstatusCredito($_SESSION['idBanco'],$estatus,$codpro,$fechaD,$fechaH,-1);
...
$listarCredito=$objBeneficiario->listarEstatusCredito($_SESSION['idBanco'],$estatus,$codpro,$fechaD,$fechaH,$offset);
...
function exel(URL) {
	  ...
	  id = day.getTime();
	  eval("page" + id +
	  	   " = window.open('reportes/xlsListarEstatusCredito.php?banco=<?php echo$_SESSION['idBanco'];?>&estatus=<?php echo$estatus;?>&codpro=<?php echo$codpro;?>&fechaD=<?php echo$fechaD;?>&fechaH=<?php echo$fechaH;?>&id='+URL,'','toolbar=0,scrollbars=1,location=0,statusbar=1,menubar=0,resizable=0,width=1100,height=900');");
...
<!--  Contenido Principal         -->
 ...
 <fieldset class="form">
  <legend>Listado  <?php echo 'Total: '.$contArt?>
  </legend>
...
?>
               ...
               <td align="center" ><?php echo $listarCredito[$i+8]?></td>
