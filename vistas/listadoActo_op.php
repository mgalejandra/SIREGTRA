...
require('../modelos/inventario.php');
	...
	$dir='http://'.$host.$uri;
    $permitidos = array(1,2,3,4,5,6,7,9,10,13,18);
...
<!--  Contenido Principal         -->
 ...
 <fieldset class="form">
  ...
  <div style="overflow: auto; width: 105%; height: 300px;">
    <table width="90%" align="center" class="detalles">
             ...
             <tr>
              ...
              <td class="cabecera">Almacen</td>
               <td class="cabecera">Ubicaci&oacute;n</td>
              <td class="cabecera">Nivel_PDI</td>
...
?>
              <tr class="<?php echo $color ?>">
			   ...
			   <td align="center" ><?php  if ($listarFactura[$i+22]=='E') echo 'No PDI'; else  echo ' ' ;?></td>
			   <td align="center" ><?php echo $listarFactura[$i+21]?></td>
