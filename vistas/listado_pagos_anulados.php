...
require('../modelos/pago.php');
	...
	$dir='http://'.$host.$uri;
    $permitidos = array(1,2,3,4,5,6,7,8,11,13,17,18,22,25);
...
$contPago = $objPago->contarPagos($pago,$id_banco,$fec1 ,$fec2 ,$sercarveh,$codpro,$nombre,$id_caso,$codStatus,$tipo);
...
if($_POST['pago']);{
if($_POST['indBusq']==3){
$listarPago=$objPago->listarPagos_Anulados($pago,$id_banco,$fec1,$fec2,$sercarveh,$codpro,$nombre,$codStatus,$offset,$nroFilas,$id_caso,$tipo);
...
$contPago = $objPago->contarPagos_Anulados($pago,$id_banco,$fec1 ,$fec2 ,$sercarveh,$codpro,$nombre,$id_caso,$codStatus,$tipo);
$listarPago=$objPago->listarPagos_Anulados($pago,$id_banco,$fec1,$fec2,$sercarveh,$codpro,$nombre,$codStatus,$offset,$nroFilas,$id_caso,$tipo);
}
...
<!--  Contenido Principal         -->
 ...
 <fieldset class="form">
  <legend>Lista de Pagos Anulados
  </legend>
    <table width="90%" align="center" class="detalles" id="tabla2">
          <!--    <tr>
            ...
            <tr>
              ...
              <td class="cabecera" colspan="4">Cheque/Transferencia</td>
               ...
               <a class="vinculo"
               	onclick="enviarPago('<?=$listarPago[$i+0]?>','<?=$listarPago[$i+1]?>'
				                ...
				                <td align="center"><?=$listarPago[$i+3]?></td>
				 		   	    <td align="center"><?=$listarPago[$i+6]?></td>
				                <td align="center" ><?=$listarPago[$i+9]?></td>
...
<?if($id_caso==2){?>
	 <? if ($_SESSION['tipoUsuario']<>'18'){?>
               <td><div align="center">
               <a class="vinculo" href="reg_pago_anulados.php?idpago=<?=$listarPago[$i]?>">
