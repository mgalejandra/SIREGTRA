...
$destino = '/var/www/refeciv1.1/archivo' ; //aca se define la direccion en la que quieres que se guarden los archivos cuando los subes al servidor
...
$fp = fopen ("/var/www/refeciv1.1/archivo/datos.csv", "r");
...
while (( $data = fgetcsv ( $fp , 500000 , "," )) !== FALSE ) { // Mientras hay líneas que leer...
     ...
     foreach($data as $row) {
		...
		$a=$num_lineas;
    	echo"<br><br> Numeros totales de Lineas: $a<br>";

?>

<br>
<form action="Carga_placas.php" method="POST" onsubmit="return checkCheckBox(this)">
