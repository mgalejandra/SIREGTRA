...
if ($indReg=='1'){
    ...
    if ($enviar){
      echo "<script>alert('Envio Cambiado de Estatus');</script>";
	}else  echo "<script>alert('No pudo ser Cambiado el Estatus del envio');</script>";
}
...
$contArt = $objenvios->contarcomboEnvio('1');
...
$comboEnvio = $objenvios->comboEnvio('1',$offset);
?>
<!DOCTYPE HTML PUBLIC >
<html>
  <head>
...
<!--  Contenido Principal         -->
 ...
 <fieldset class="form">
  <legend>Listado de Envios al INTT Pendiente por estatus</legend> <input  type="button" onclick="enviar(1); return false" value="Enviar" />
...
?>
               ...
               <td align="center"><input type="radio" name="estatus[<?php echo $i/10?>]" value="P" <?php if($comboEnvio[$i+7]=='P')  $checked='checked';?> <?php echo $checked; $checked=null;?>  ></td>
               <td align="center"><input type="radio" name="estatus[<?php echo $i/10?>]" value="A" <?php if($comboEnvio[$i+7]=='A')  $checked='checked';?>  <?php echo $checked; $checked=null;?> ></td>
               <td align="center"><input type="radio" name="estatus[<?php echo $i/10?>]" value="R" <?php if($comboEnvio[$i+7]=='R')  $checked='checked';?>  <?php echo $checked; $checked=null;?> ></td>
              </tr>
<?php     }
        }
?>
