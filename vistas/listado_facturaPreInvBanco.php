...
$contArt = $objFactura->contarFacturasPreInv($id_numfac,$sercarveh,$fec,$fec2,$codpro,$nombre,$tipo,$estatus, $_SESSION['idBanco'] ,$usuario,$cond, $sig, $dia ,$edad ,$estado,$sexo,$diat,$codmar,$codmodveh,$codserveh,$numlotveh,$numplaveh,$taller,$tt,$fecE,$fecE2,$tipoE,$tipoben,$fecfacori1,$fecfacori2,$numfacori);
//$contArt = 0;
...
$listarFactura=$objFactura->listarFacturasPreInv($id_numfac,$sercarveh,$fec,$fec2,$offset,$codpro,$nombre,$tipo,$estatus, $_SESSION['idBanco'] ,$usuario,$cond, $sig, $dia ,$edad ,$estado,$sexo ,$diat,$codmar,$codmodveh,$codserveh,$numlotveh,$numplaveh,$taller,$tt,$fecE,$fecE2,$tipoE,$tipoben,$fecfacori1,$fecfacori2,$numfacori);
...
?>
	          ...
	          <? }?>
	           ...
	           <td><div align="center">
               <a class="vinculo" href="<?php if($listarFactura[$i+6]=='CREDITO'){?>det_factura_banco<?php } if($listarFactura[$i+6]=='CONTADO'){?>det_factura_suvincaC<?php } ?>.php?idfactura=<?php echo $listarFactura[$i]?>&tip=<?php echo $tipo; ?>&preinv=<? echo $preinv1; ?>">
