...
function Footer(){
  ...
  if($this->DefOrientation == 'P'){
    ...
    //Page number
    $this->MultiCell(190,3,utf8_decode(' Documento sin Validez Fiscal'),0,'C');
  ...
  if($this->DefOrientation == 'L'){
    ...
    $this->SetFont('Arial','B',7);
    //Page number
    $this->MultiCell(260,3,utf8_decode('IMCP  Instituo Municipal de Credito Popular, Caracas - Dtto. Capital '),0,'C');
...
function cabecera3($cabecera,$anchos){
    //Colors, line width and bold font
    $this->SetFillColor(204,204,204);
    $this->SetTextColor(0);
    $this->SetDrawColor(0,0,0);
