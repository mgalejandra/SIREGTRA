...
function Header()
{
    global $title;
    //Logo
    $this->Image('imagenes/cintillo.jpg',10,15,195);
...
function creaMembrete($datos){
    $this->SetFont('Arial','',10);
    $this->Cell(195,5,utf8_decode('USUARIO: '.$datos[2]),'LRT',1,'J',0);
    $this->Cell(195,5,utf8_decode('RIF: '.$datos[1]),'LR',1,'J',0);
    $this->Cell(195,5,utf8_decode('DIRECCIÓN DESPACHO: '.$datos[4]),'LR',1,'J',0);
    $this->Cell(195,5,utf8_decode('DIRECCIÓN FISCAL: '.$datos[3]),'LR',1,'J',0);
    $this->Cell(195,5,utf8_decode('FECHA ELABORACIÓN: '.date("d-m-Y")),'LRB',1,'J',0);
    $this->Ln();
}
